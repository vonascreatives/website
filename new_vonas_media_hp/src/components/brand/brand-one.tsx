...
const BrandOne = ({ brands, homepageImages }: IProps) => {
  return (
          ...
          <div className="row align-items-center">
            <div className="col-xxl-2 col-xl-3 col-lg-3">
              <div className="tp-brand-title-box">
                <h4 className="tp-brand-title tp_fade_bottom">Brands We Partner With</h4>
              </div>
            </div>
              ...
              <div className="row align-items-center">
                <div className="col-xl-12">
                  <div className="tp-brand-slider-wrapper">
                    <BrandSlider brands={brands} homepageImages={homepageImages} />
                  </div>
                </div>
              </div>
            </div>
