            ...
            <div className="col-xl-8">
              <div className="portfolio-filter masonary-menu d-flex justify-content-center mb-60" role="group" aria-label="Portfolio filter buttons">
                <button 
                  ...
                  className="active"
                  aria-pressed="true"
                  aria-label="Show all portfolio items"
                >
                  <span>SHOW ALL</span>
                </button>
                <button 
                  data-filter=".cat1"
                  aria-pressed="false"
                  aria-label="Filter by agency portfolio items"
                >
                  <span>AGENCY</span>
                </button>
                <button 
                  data-filter=".cat2"
                  aria-pressed="false"
                  aria-label="Filter by visual portfolio items"
                >
                  <span>Visual</span>
                </button>
                <button 
                  data-filter=".cat3"
                  aria-pressed="false"
                  aria-label="Filter by shooting portfolio items"
                >
                  <span>SHOOTING</span>
                </button>
                <button 
                  data-filter=".cat4"
                  aria-pressed="false"
                  aria-label="Filter by studio portfolio items"
                >
                  <span>STUDIO</span>
                </button>
              </div>
