...
// service data - Updated for Vonas Media branding
const service_data = [
  {
    id: 1,
    icon: s_icon_1,
    subtitle: "Content that connects",
    title: "Digital Formats that Scale",
    desc: "We create new formats specifically tailored to appeal to millennials and Gen X.",
  },
  {
    id: 2,
    icon: s_icon_2,
    subtitle: "Brand presence",
    title: "Cohesive Online Identity",
    desc: "Building digital content that inspires social thinking and engagement.",
  },
  {
    id: 3,
    icon: s_icon_3,
    subtitle: "Purpose-driven media",
    title: "Redefining Digital Age",
    desc: "Evolving the way people consume information and entertainment.",
  },
];
