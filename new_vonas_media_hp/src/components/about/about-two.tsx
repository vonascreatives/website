          ...
          <div className="col-xl-10 col-md-10">
            <div className="tp-about-4-title-box tp_fade_bottom">
              <h4 className="tp-about-4-title">
                Discover the creative minds behind Vonas Media&apos;s digital
                content revolution and cultural storytelling
              </h4>
            </div>
          </div>
        </div>
              ...
              <div className="row">
                <div className="col-xl-6 col-lg-6">
                  <div className="tp-about-4-content item-1 tp_fade_bottom">
                    <p>
                      We create meaningful digital content that bridges traditional
                      Filipino culture with modern social media landscapes.
                      Our platform amplifies important voices and stories.
                    </p>
                ...
                <div className="col-xl-6 col-lg-6">
                  <div className="tp-about-4-content item-2 tp_fade_bottom">
                    <p>
                      From &quot;At the Backdoor&quot; social discussions to &quot;Skyline Music&quot;
                      artistic showcases, we redefine media for millennials
                      and Gen X audiences seeking authentic content.
                    </p>
