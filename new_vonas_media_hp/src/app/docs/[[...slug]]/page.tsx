...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const slug = slugArray ? `/docs/${slugArray.join('/')}` : '/docs'
  ...
  const description = page.seoDescription || page.description || 'Comprehensive documentation and guides for Vonas Media services.'
  const keywords = page.tags || ['documentation', 'guides', 'help', 'support']
...
export default async function DocsPage({ params }: PageProps) {
  ...
  if (page.section) {
    breadcrumbs.push({
      ...
      href: `/docs/${page.section.slug.current}`
    })
  }
