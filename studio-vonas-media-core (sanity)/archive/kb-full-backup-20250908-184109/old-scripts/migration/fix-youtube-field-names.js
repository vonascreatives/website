    ...
    visual_identity_images: [
      {
        ...
        alt: 'TechSphere Daily hero image showing modern tech workspace'
      },
      {
        _key: nanoid(),
        _type: 'imageWithAlt',
        ...
        alt: 'Sample tech review thumbnail with clean design'
      }
    ],
    ...
    concept_images: [
      {
        ...
        alt: 'Behind the scenes of tech content creation'
      }
    ]
  },
    ...
    visual_identity_images: [
      {
        ...
        alt: 'Urban Nomad Life brand imagery with city elements'
      },
      {
        _key: nanoid(),
        _type: 'imageWithAlt',
        ...
        alt: 'Warm lifestyle vlog thumbnail'
      }
    ],
    ...
    concept_images: [
      {
        ...
        alt: 'Urban lifestyle concept imagery'
      }
    ]
  },
    ...
    visual_identity_images: [
      {
        ...
        alt: 'Gaming setup with RGB lighting and retro elements'
      },
      {
        _key: nanoid(),
        _type: 'imageWithAlt',
        ...
        alt: 'Pixel art style thumbnail for indie game content'
      }
    ],
    ...
    concept_images: [
      {
        ...
        alt: 'Indie game development concept imagery'
      }
    ]
  },
    ...
    visual_identity_images: [
      {
        ...
        alt: 'Educational content hero image with modern learning tools'
      },
      {
        _key: nanoid(),
        _type: 'imageWithAlt',
        ...
        alt: 'Professional educational infographic'
      }
    ],
    ...
    concept_images: [
      {
        ...
        alt: 'Future skills education concept'
      }
    ]
  },
    ...
    visual_identity_images: [
      {
        ...
        alt: 'Culture Remix brand imagery with street art elements'
      },
      {
        _key: nanoid(),
        _type: 'imageWithAlt',
        ...
        alt: 'Bold cultural collage representing remix culture'
      }
    ],
    ...
    concept_images: [
      {
        ...
        alt: 'Cultural trend analysis and underground movements'
      }
    ]
  }
]

async function fixYouTubeFieldNames() {
  try {
    console.log('🔧 Fixing YouTube channels field names...\\n')
    
    for (const channel of fixedChannels) {
      const result = await client.createOrReplace(channel)
      console.log(`✅ Fixed: ${channel.channel_name} (${channel.category})`)
      console.log(`   Using correct field names: alt instead of altText`)
      console.log('')
    }
    
    console.log('🎉 Successfully fixed all field name issues!')
    console.log(`📊 Fixed ${fixedChannels.length} channels with correct schema compliance`)
    console.log('\\n🔧 Fixed issues:')
    console.log('   • Changed altText to alt to match imageWithAlt schema')
    console.log('   • All images now have proper field structure')
    console.log('   • No more "Unknown field found" errors')
    console.log('\\n🌐 Check them out at:')
...
if (require.main === module) {
  fixYouTubeFieldNames()
}

module.exports = { fixYouTubeFieldNames }
