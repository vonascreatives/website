                  ...
                  S.list()
                    ...
                    .items([
                      S.listItem()
                        ...
                        .child(S.documentTypeList('kbItem').filter('_type == "kbItem" && (title match "*About*" || title match "*Company*" || title match "*Vision*" || title match "*Mission*" || title match "*Values*")')),
                      S.listItem()
                        .title('Policies & SOPs')
                        .child(S.documentTypeList('kbItem').filter('_type == "kbItem" && (title match "*Policy*" || title match "*SOP*" || title match "*Guide*" || docType == "policy")')),
                      S.listItem()
                        .title('Team & HR')
                        .child(S.documentTypeList('kbItem').filter('_type == "kbItem" && (title match "*Team*" || title match "*HR*" || title match "*Structure*" || title match "*Role*")')),
                      S.listItem()
                        .title('Interns & Training')
                        .child(S.documentTypeList('kbItem').filter('_type == "kbItem" && (title match "*Intern*" || title match "*Onboarding*" || title match "*Training*")')),
                      S.listItem()
                        .title('Freelancers')
                        .child(S.documentTypeList('kbItem').filter('_type == "kbItem" && (title match "*Freelancer*" || title match "*External*" || title match "*Collaboration*")')),
                      S.divider(),
                      S.listItem()
                        .title('All Company Documents')
                        .icon(DocumentsIcon)
                        .child(S.documentTypeList('kbItem').filter('_type == "kbItem" && (title match "*Company*" || title match "*VONAS*" || title match "*Team*" || title match "*Policy*" || title match "*HR*" || title match "*Intern*" || title match "*Freelancer*")')),
                    ])
                ),
                          ...
                          S.list()
                            ...
                            .items([
                              ...
                              S.listItem()
                                .title('All OTR Documents')
                                .icon(DocumentsIcon)
                                .child(S.documentTypeList('kbItem').filter('_type == "kbItem" && parent._ref in ["kb.shows.otr.pre-production", "kb.shows.otr.production", "kb.shows.otr.post-production", "kb.shows.otr.distribution", "kb.shows.otr.visual-identity"]')),
                            ])
                        ),
                      S.listItem()
                        .title('Skyline')
